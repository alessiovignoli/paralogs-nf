...
parser.add_argument("-S","--supermatrix", action='store_true', dest='only_supermatrix', help='Output only the supermatrix alignment')
...
if args.only_supermatrix==True:
	for f in args.aln:
		...
		times += 1
	ph_outfile = args.fam + '_supermatrix.phylip'
	ph_out = open(ph_outfile,"w")
	AlignIO.write(supermatrix,ph_out,"phylip")
	ph_out.close()
